...
dns_records = {
    ...
    # Additional DNS records can be added here
}
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    for pref, server in answer_data:
                        rdata_list.append(MX(dns.rdataclass.IN, dns.rdatatype.MX, preference=pref, exchange=dns.name.from_text(server)))
                    ...
                    if isinstance(answer_data, str) or isinstance(answer_data, list):
